...
document.querySelector('.gameframe').contentWindow.document.head.appendChild(Object.assign(document.createElement("style"), { innerHTML: ".room-view,.roomlist-view{height:100%;margin-top:0}.game-view>.top-section,.room-view{margin-top:0}.settings-view{width:100%;max-height:none}.game-view>[data-hook=popups]{background-color:#ffffff}.disconnected-view .dialog,.disconnected-view .room-view>.container{width:450px}.create-room-view>.dialog,.room-view.create-room-view>.container{max-width:450px;width:100%} body {
  background-image: url('https://cdn.discordapp.com/attachments/1304956298273488916/1304970809525276703/20241109_194715_199.jpg?ex=67315446&is=673002c6&hm=b9af3e9cf8fea970b3dbe056e7dc15da9fddceaba2f65fcaeb80a7427c02e852&');
}
