...
const constrolsStyleBase = "#joystick,#kick{z-index:100;bottom:CONTROLS_MARGINvw}.neo{opacity:CONTROLS_OPACITY;background-color:#08FFCE;box-shadow:6px 6px 10px 0 #08FFCE,-5px -5px 9px 0 #08FFCE;color:#dedede55;font-weight:bolder;font-size:1.5rem}.sizer{width:CONTROLS_WIDTH%;aspect-ratio: 1 / 1;}#joystick{left:CONTROLS_MARGIN%;overflow:visible}#thumb{width:40%;height:40%;background-color:#08FFCE}#kick{right:CONTROLS_MARGIN%}button.neo:active{opacity:KICK_OPACITY}";
...
function createURLButton() {
    ...
    button.addEventListener("click", function() {
        if (!body.querySelector('[data-hook="input-url"]')) {
            ...
            urlForm.innerHTML = '<div class="label-input" style="background-color: blue"><label>URL:</label><input data-hook="input-url" type="url"></div>';
