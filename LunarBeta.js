...
const PASSWORDI_BUTTON = true;

const CUSTOM_CSS = `.game-view>.top-section,.room-view{margin-left:5}.stats-view,[data-hook=ok]{text-transform:uppercase}*{user-select:none}body{background-image:url('https://cdn.discordapp.com/attachments/1304956298273488916/1305338595271507999/image_search_1731215899331.jpg?ex=6732aacd&is=6731594d&hm=31015250aac2cca6d5c94304ccf387c4211674bdd00368876793c8ac0243aa4a&');background-size:cover;opacity:20%}[data-hook=leave-btn]{background:#c13535!important;margin-right:6px}.inputrow,.roomlist-view>.dialog>.splitter>.buttons>.sound-button-container,[data-hook=tvideo-lowlatency],[data-hook=tvideo-showavatars],[data-hook=tvideo-showindicators],[data-hook=tvideo-teamcol],div.chatbox-view>div>div.input,div:has(> [data-hook=chatbgmode]),div:has(> [data-hook=chatfocusheight-range]),div:has(> [data-hook=chatopacity-range]){display:none!important}div.chatbox-view>div>div.input{pointer-events:all}div.chatbox-view>div>div.input>input{overflow:hidden}.game-view>[data-hook=popups]{background-color:transparent!important}h1{border-bottom-color:#fec45b!important}.room-view{margin-bottom:3;height:50%}.room-view>.container{margin-left:8!important;max-width:none;max-height:none;border-radius:1;width:50%;margin-bottom:36px}.room-view>.container>.header-btns{bottom:1;top:2px;display:flex;flex-flow:row-reverse;left:40px;right:auto}[data-hook=stadium-pick]{position:fixed!important;background:0 0!important;color:transparent!important;width:300px;height:20px}[data-hook=stadium-name]{text-decoration:underline}.room-view>.container>.controls{display:flex;align-self:center;position:absolute;bottom:6;right:50px;top:10px;margin-bottom:30px!important;z-index:1;flex-flow:row-reverse}.settings-view{width:50%;height:50%;max-height:unset;border-radius:2px}.settings-view .tabcontents{width:70%;text-align:-webkit-center}.settings-view .section.selected{display:flex;width:max-content}.choose-nickname-view{flex-direction:row-reverse;right:20px}.fade-out{opacity:0;transition:opacity 10s ease-out}.game-view>.bottom-section{position:absolute;bottom: 10px;left:10px;width:50%;height:80%;pointer-events:none}.roomlist-view>.dialog,.view-wrapper>.dialog{max-width:calc(50vw - 2vw);max-height:calc(50vh - 2vw)}.chatbox-view-contents>.drag,.graph,.showing-room-view>.gameplay-section{display:none}body>div>div>div.dialog>p:nth-child(2){font-size:10%}body>div>.roomlist-view>div.dialog>p:nth-child(2)::after{font-size:medium;content:"HaxBall Mobile is now Open-Source. Feel free to make and publish improvements to the developer community";font-weight:400}.filters::after{content:"Vixel Dev 2024 - InjecThor";white-space:pre;font-style:italic}button[data-hook=shirt-btn]:after{content:"◑";font-size:1.25em}button[data-hook=shirt-btn]{margin-right:6px;margin-left:6px}div.chatbox-view>div>div.log.subtle-thin-scrollbar>div>p{display:none;text-shadow:1px 0 4px rgba(0,0,0,.66)}div.chatbox-view>div>div.log.subtle-thin-scrollbar>div>p:nth-last-child(-n+5){opacity:1;display:block;animation:10s forwards fadeOut}.log>div>p:has(br){display:none!important}@keyframes fadeOut{0%{opacity:1}70%{opacity:0;display:none}}.chatbox-view-contents{flex-direction:column-reverse;pointer-events:none;background:0 0;height:50vh;position:absolute;text-align:center;align-items:center;top:10px;width:20vw}.showing-room-view>.bottom-section>.chatbox-view>div{top:0!important}.chatbox-view-contents>.log{flex-direction:column}.chatbox-view{pointer-events:none;position:absolute;left:20px;top:0;height:0!important;overflow-y:visible}.log-contents{display:flex;flex-direction:column-reverse}.stats-view{left:100%;bottom:1px;background-color:transparent;text-shadow:1px 2px 1px #000,0 1px 1px #000;padding:8px;margin:4px;line-height:1.5em;position:absolute;text-align:center!important;opacity:.25;width:min-content;transform:translate(-50%,0);pointer-events:all;display:flex;flex-direction:column-reverse}.chatbox-view-contents>.autocompletebox{position:relative}.file-btn, [data-hook=rec-btn]`;
    ...
    if (!getByDataHook("loader-view")) {
        if (body.querySelector('.roomlist-view')) {
            ...
            if (body.querySelector('.room-view .admin')) {
                ...
                if (!getByDataHook('passwordi-btn')) createPasswordiButton();
            }
            handleFPSText()
